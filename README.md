...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "Made By V4MP6RE Fixed By Nathan Added more tabs and section by TANSHU inspired by Gaming Scripter"; -- what the text says (ofc)
...
local Section2 = Tab:NewSection("MatzScripter#7980")

local Section3 = Tab:NewSection("Added more tabs and more sections TANSHU#5576")

local Section4 = Tab:NewSection("Made By V4MP6RE#6350")

local Section5 = Tab:NewSection("Inspired by gaming scripter")
...
local Section6 = Tab2:NewSection("Fixed By Nathan")

local Tab4 = Window:NewTab("MM2")

local Section7 = Tab3:NewSection("MM2 OP GUI")

local Tab5 = Window:NewTab("Bedwars")

local Section8 = Tab4:NewSection("Darkai Op")
...
Section5:NewButton("Keyboard", "A Keyboard For Mobile", function()
...
Section6NewButton("Auto Clicker", "Auto Clicker For Mobile", function()
...
Section7:NewButton("MM2", "A MM2 hack For Mobile", function()
...
Section8:NewButton("Darkai Op", "Pro Hub", function()
...
Section8:NewButton("OP", "Pro Hub", function()
...
Section9:NewButton("Prison Life Op"), "A Prison Life Script For Mobile", function()
 ...
 Section10:NewLabel("Animation")

Section10:NewButton("Animation"), "A Animation script For Mobile", function()
...
Main:TweenPosition(UDim2.new(0.421999991, 0, 0.28400004, 0))
 ...
 Section11:NewLabel("Fling")

Section11:NewButton("Fling"), "A Fling Script For Mobile", function()
...
local poop = nil
 ...
 Section12:NewLabel("Fly")

Section12:NewButton("Fly Script"), "A Fly Script For Mobile", function()
...
Section13:NewButton("Arsenal script"), "A Arsenal script or Mobile", function()
